    ...
    return (
        <label className="swap swap-rotate">
            ...
            <svg
                ...
                className="swap-off h-10 w-10 fill-current hover:brightness-75 transition-all"
            >
            ...
            <svg
                ...
                viewBox="0 -960 960 960"
                className="swap-on h-10 w-10 fill-current hover:brightness-75 transition-all"
            >
