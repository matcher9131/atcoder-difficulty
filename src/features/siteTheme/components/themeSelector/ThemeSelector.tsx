...
export const ThemeSelector = ({ isDarkMode, onChange }: ThemeSelectorProps): ReactNode => {
    ...
    return (
        <label className="swap swap-rotate hover:invert-30 transition-all">
            ...
            <svg
                ...
                className="swap-off h-10 w-10 fill-current transition-all"
            >
            ...
            <svg
                ...
                viewBox="0 -960 960 960"
                className="swap-on h-10 w-10 fill-current transition-all"
            >
