...
export const RatingInput = ({
    ...
    return (
        <div className={clsx("text-left", "flex", "gap-x-2", className)}>
            ...
            <div className="tooltip tooltip-right flex items-center" data-tip={t("ratingInput.tooltipText")}>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    role="img"
                    aria-label={t("ratingInput.tooltipText")}
                    viewBox="0 -960 960 960"
                    className="h-6 w-6 fill-info cursor-pointer hover:brightness-75 transition-all"
                >
